Cast.prototype.getView = function (viewInfo) {
	if (viewInfo instanceof Array) {
		return new this.SUPPORTED_VIEWS[viewInfo[0]](this,viewInfo[1]);
	} else if (typeof(viewInfo) == "string") {
		return new this.SUPPORTED_VIEWS["text"](this,viewInfo);
	} else if (viewInfo instanceof Object) {
		return new this.SUPPORTED_VIEWS[viewInfo.view](this,viewInfo);
	} else {
